...
export const unifiedAPI = {
  ...
  getCashierDashboardMetrics: async (params = {}) => {
    try {
      ...
      const response = await api.get('/cashier/dashboard-metrics', { params });
      const metrics = response.data?.data || response.data;
...
export const transactionAPI = {
  ...
  // In your api.js - update the create method
...
export const reportAPI = {
  ...
  // NEW: Get cashier dashboard data
  getCashierDashboard: async (filters = {}) => {
    try {
      console.log('👤 Fetching cashier dashboard data...', filters);
